...
0.0008877
```
This example shows that the probability is about 0.09% that four features, each occuring with frequency 3/10, will simultaneously occur in 2 or more members.
